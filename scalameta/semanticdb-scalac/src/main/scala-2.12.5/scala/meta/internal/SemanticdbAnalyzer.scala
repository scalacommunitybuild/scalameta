// NOTE: this is *not* the real scalameta one!
// this is to make the community build pass after scala/scala#6087
// the real scalameta one will be made by the real scalameta people at the real scalameta time
// this one is current as of scala/scala@09ebc826968b
...
trait SemanticdbAnalyzer extends NscAnalyzer with ReflectionToolkit {
  ...
  import statistics.{failedApplyNanos, failedOpEqNanos, typedApplyCount, typedSelectCount}
          ...
          pt.dealias match {
            ...
            case _ =>
              if (hasUndets) instantiate(tree, mode, pt)
                ...
                // which is to say, it should be made to not e
